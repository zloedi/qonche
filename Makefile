demo_gui.exe: demo_gui.c zh_ui.h zh_apple_font.h qonche.h
	x86_64-w64-mingw32-gcc -o demo_gui.exe demo_gui.c -O0 -g -Wall -Wextra -Wshadow -mconsole -ISDL2-2.0.14/x86_64-w64-mingw32/include/SDL2 -Dmain=SDL_main -LSDL2-2.0.14/x86_64-w64-mingw32/lib `./SDL2-2.0.14/x86_64-w64-mingw32/bin/sdl2-config --static-libs`

demo.exe: demo.c zh_ui.h zh_apple_font.h qonche.h
	x86_64-w64-mingw32-gcc -o demo.exe demo.c -O0 -g -Wall -Wextra -Wshadow -mconsole -ISDL2-2.0.14/x86_64-w64-mingw32/include/SDL2 -Dmain=SDL_main -LSDL2-2.0.14/x86_64-w64-mingw32/lib `./SDL2-2.0.14/x86_64-w64-mingw32/bin/sdl2-config --static-libs`
